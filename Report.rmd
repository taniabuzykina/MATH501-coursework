...
xygrid.predict %>% ggplot(aes(x = Comp.1, y = Comp.2, color = col)) +
  ...
  labs(x = "Principal Component 1", y = "Principal Component 2",
       color = "Churn") +
  scale_color_manual(labels = c("Yes", "No"), values = c("green", "red"))
```

We can observe that most of the customers who have decided to switch to a different operator have values higher than 1.25 of Principal Component 1 which focuses on internet speed factors like 'upload' and 'webget'.
...
[(Amplitude, 2021) The Guide to Data Accessibility](https://amplitude.com/data-accessibility) Accessed: 10 April 2021
