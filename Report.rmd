...
churn_data %>% ggplot(aes(x = churn, y = webget, color = churn)) + 
 ...
 labs (y = "Average time to load a webpage", 
       ...
       color = "Switched")
```
<!-- We can presume that there is a strong dependency between the time to load a webpage (which directly corresponds to the downlink speed) and an indicator whether customers changed their operators. The average downlink speed was significantly lower for the customers that have switched to a different provider (around 550 units) than for those who haven't (around 350 units). We can conclude this as the average time to load a webpage, for those clients who switched, is nearly 200 units longer than of those who didn't. To clarify, the longer it takes to load a webpage the lower is the Internet download (downlink) speed. Downlink is often more important in 4G society as people spend more time watching (loading) videos and browsing social media (web) pages, music etc - which solely relies on download speed. -->
